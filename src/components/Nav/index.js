...
import { sessionLogout } from "../../store/modules/Session/actions";
      ...
      <NavContainer openMenu={openMenu}>
        ...
        <ul>
          ...
          <li>
            ...
            <Link to="https://github.com/danyelhenrique" target="_blank">
              GitHub
            </Link>
          </li>
          <li>
            ...
            <Link
              to="https://www.linkedin.com/in/danyel-henrique"
              target="_blank"
            >
              Linkedin
            </Link>
          ...
          {isloggedin && (
            <li>
              <MdAccountCircle size={24} color="#fff" />
              <button onClick={() => dispatch(sessionLogout())}>Logout</button>
            </li>
          )}
        </ul>
      </NavContainer>
